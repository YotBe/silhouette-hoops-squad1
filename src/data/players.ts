...
export const PLAYERS: Player[] = [
  ...
  // ─── CURRENT STARS EXPANSION ──────────────────────────────────────────────
  {
    id: 'sabonis', name: 'Domantas Sabonis', team: 'Kings', teamColor: '263 52% 33%',
    position: 'C', number: 10, nickname: 'Sabo', tier: 'allstar',
    videoFile: '', imageUrl: espn(3155942),
    college: 'Gonzaga', draftYear: 2016,
    facts: ['Led the NBA in rebounds per game in 2023 and 2024', 'Son of Hall of Famer Arvydas Sabonis', 'One of the best passing big men in the modern NBA'],
    stats: { ppg: '19.4', rpg: '13.7', apg: '7.3' },
    clues: ['This C led the NBA in rebounds and is the son of a Hall of Famer', 'He wears #10 for the Sacramento Kings', 'Domantas Sabonis — elite passing big man'],
  },
  {
    id: 'siakam', name: 'Pascal Siakam', team: 'Pacers', teamColor: '200 80% 38%',
    position: 'PF', number: 43, nickname: 'Spicy P', tier: 'allstar',
    videoFile: '', imageUrl: espn(3149673),
    college: 'New Mexico State', draftYear: 2016,
    facts: ['Won Most Improved Player in 2019', 'Key starter on the 2019 NBA Champion Toronto Raptors', 'Born in Cameroon and did not start playing basketball until age 17'],
    stats: { ppg: '21.7', rpg: '7.5', apg: '4.1' },
    clues: ['This Cameroon-born PF won MIP in 2019 and a championship that same year', 'He wears #43 and is nicknamed "Spicy P"', 'Pascal Siakam — Pacers PF'],
  },
  {
    id: 'mobley', name: 'Evan Mobley', team: 'Cavaliers', teamColor: '0 72% 51%',
    position: 'C', number: 4, nickname: 'Ice', tier: 'pro',
    videoFile: '', imageUrl: espn(4432158),
    college: 'USC', draftYear: 2021,
    facts: ['Runner-up for Rookie of the Year in 2022', 'One of the most versatile defensive big men in the NBA', 'Can guard all five positions at 7 feet tall'],
    stats: { ppg: '15.7', rpg: '9.4', apg: '3.2' },
    clues: ['This 7-foot C can guard all five positions for Cleveland', 'He wears #4 and was drafted #3 overall in 2021', 'Evan Mobley of the Cavaliers'],
  },
  {
    id: 'jalenw', name: 'Jalen Williams', team: 'Thunder', teamColor: '210 100% 40%',
    position: 'SF', number: 8, nickname: 'J-Dub', tier: 'pro',
    videoFile: '', imageUrl: espn(4683634),
    college: 'Santa Clara', draftYear: 2022,
    facts: ['Rose from a mid-major school to become an NBA star', 'Key piece alongside SGA in OKC\'s rebuild', 'Known for his ambidextrous finishing at the rim'],
    stats: { ppg: '21.0', rpg: '5.6', apg: '5.1' },
    clues: ['This SF from Santa Clara became a key star in OKC', 'He wears #8 for the Thunder and is nicknamed "J-Dub"', 'Jalen Williams — Thunder SF'],
  },
  {
    id: 'sengun', name: 'Alperen Sengun', team: 'Rockets', teamColor: '0 72% 51%',
    position: 'C', number: 28, nickname: 'Al-P', tier: 'pro',
    videoFile: '', imageUrl: espn(4683025),
    college: 'Besiktas (Turkey)', draftYear: 2021,
    facts: ['Won Turkish League MVP before turning 19', 'One of the best passing centers in the NBA', 'Known for crafty post moves and creative footwork'],
    stats: { ppg: '19.0', rpg: '9.3', apg: '5.0' },
    clues: ['This Turkish C is one of the best passing big men in the league', 'He wears #28 for the Houston Rockets', 'Alperen Sengun — crafty Rockets center'],
  },
  {
    id: 'herro', name: 'Tyler Herro', team: 'Heat', teamColor: '0 72% 51%',
    position: 'SG', number: 14, nickname: 'Boy Wonder', tier: 'allstar',
    videoFile: '', imageUrl: espn(4395725),
    college: 'Kentucky', draftYear: 2019,
    facts: ['Won Sixth Man of the Year in 2022', 'Scored 37 points in an NBA Finals game as a 20-year-old', 'Known for his confident swagger and clutch shooting'],
    stats: { ppg: '23.0', rpg: '5.3', apg: '4.7' },
    clues: ['This SG won Sixth Man of the Year at age 22', 'He wears #14 for the Miami Heat', 'Tyler Herro — Boy Wonder'],
  },
  {
    id: 'reaves', name: 'Austin Reaves', team: 'Lakers', teamColor: '263 52% 33%',
    position: 'SG', number: 15, nickname: 'AR-15', tier: 'pro',
    videoFile: '', imageUrl: espn(4395652),
    college: 'Oklahoma', draftYear: 2021,
    facts: ['Went undrafted in 2021 and became a Lakers starter', 'Hit a game-winning shot in overtime of a playoff game', 'One of the best undrafted players in the modern NBA'],
    stats: { ppg: '17.8', rpg: '4.6', apg: '5.5' },
    clues: ['This undrafted SG became a starter and fan favorite for the Lakers', 'He wears #15 and is nicknamed "AR-15"', 'Austin Reaves — Lakers guard'],
  },
  {
    id: 'simons', name: 'Anfernee Simons', team: 'Blazers', teamColor: '0 72% 51%',
    position: 'SG', number: 1, nickname: 'Ant', tier: 'allstar',
    videoFile: '', imageUrl: espn(4351852),
    college: 'IMG Academy (went straight to NBA)', draftYear: 2018,
    facts: ['Won the 2023 Three-Point Contest', 'Took over as Portland\'s franchise guard after Damian Lillard trade', 'Drafted straight out of high school at age 19'],
    stats: { ppg: '22.6', rpg: '3.0', apg: '5.5' },
    clues: ['This SG won the 2023 Three-Point Contest and took over after Dame left', 'He wears #1 for the Portland Trail Blazers', 'Anfernee Simons — Blazers SG'],
  },
  {
    id: 'white', name: 'Derrick White', team: 'Celtics', teamColor: '150 61% 35%',
    position: 'SG', number: 9, nickname: 'D-White', tier: 'allstar',
    videoFile: '', imageUrl: espn(2578185),
    college: 'Colorado', draftYear: 2017,
    facts: ['Key contributor on the 2024 NBA Champion Celtics', 'Did not play Division I basketball until his junior year', 'Known for elite perimeter defense and timely three-point shooting'],
    stats: { ppg: '15.2', rpg: '4.2', apg: '5.2' },
    clues: ['This SG is a 2024 champion known for elite defense and clutch threes', 'He wears #9 for the Boston Celtics', 'Derrick White — Celtics guard'],
  },
  {
    id: 'bane', name: 'Desmond Bane', team: 'Grizzlies', teamColor: '190 55% 40%',
    position: 'SG', number: 22, nickname: 'Bane', tier: 'allstar',
    videoFile: '', imageUrl: espn(4066423),
    college: 'TCU', draftYear: 2020,
    facts: ['Drafted 30th overall and became a franchise cornerstone', 'One of the best three-point shooters in the NBA', 'Forms a dynamic duo with Ja Morant in Memphis'],
    stats: { ppg: '23.7', rpg: '5.0', apg: '4.4' },
    clues: ['This SG was a late first-round pick who became a franchise star', 'He wears #22 for the Memphis Grizzlies', 'Desmond Bane — Grizzlies sharpshooter'],
  },
  {
    id: 'camthomas', name: 'Cam Thomas', team: 'Nets', teamColor: '0 0% 20%',
    position: 'SG', number: 24, nickname: 'Bucket', tier: 'pro',
    videoFile: '', imageUrl: espn(4432164),
    college: 'LSU', draftYear: 2021,
    facts: ['Scored 50+ points multiple times before turning 23', 'One of the most prolific young scorers in the NBA', 'Known for his fearless shot-making and Kobe-like mentality'],
    stats: { ppg: '24.7', rpg: '3.3', apg: '3.8' },
    clues: ['This SG scored 50+ multiple times before age 23', 'He wears #24 for the Brooklyn Nets', 'Cam Thomas — elite young scorer'],
  },
  {
    id: 'jalengreen', name: 'Jalen Green', team: 'Rockets', teamColor: '0 72% 51%',
    position: 'SG', number: 4, nickname: 'JG', tier: 'pro',
    videoFile: '', imageUrl: espn(4432171),
    college: 'G League Ignite', draftYear: 2021,
    facts: ['#2 overall pick in the 2021 NBA Draft', 'One of the most explosive dunkers among young guards', 'Skipped college for the G League Ignite program'],
    stats: { ppg: '21.1', rpg: '3.7', apg: '3.2' },
    clues: ['This explosive SG went #2 in 2021 from the G League Ignite', 'He wears #4 for the Houston Rockets', 'Jalen Green — Rockets guard'],
  },
  {
    id: 'horford', name: 'Al Horford', team: 'Celtics', teamColor: '150 61% 35%',
    position: 'C', number: 42, nickname: 'Big Al', tier: 'mvp',
    videoFile: '', imageUrl: espn(3213),
    college: 'Florida', draftYear: 2007,
    facts: ['Won his first NBA Championship at age 37 with the 2024 Celtics', 'Dominican-born center who played 17+ NBA seasons', 'Known for his basketball IQ, passing, and versatile defense'],
    stats: { ppg: '13.4', rpg: '8.2', apg: '3.4' },
    clues: ['This Dominican-born C won his first ring at age 37 in 2024', 'He wears #42 and has played 17+ NBA seasons', 'Al Horford — Big Al'],
  },
  {
    id: 'dysondaniels', name: 'Dyson Daniels', team: 'Hawks', teamColor: '0 72% 51%',
    position: 'SG', number: 5, nickname: 'Dyson', tier: 'pro',
    videoFile: '', imageUrl: espn(4871145),
    college: 'G League Ignite (Australia)', draftYear: 2022,
    facts: ['Australian guard who became an elite perimeter defender', 'Led the NBA in steals per game in 2024-25', 'Known for his lockdown on-ball defense at 6\'8"'],
    stats: { ppg: '13.1', rpg: '4.9', apg: '3.5' },
    clues: ['This 6\'8" Australian SG led the league in steals', 'He wears #5 for the Atlanta Hawks', 'Dyson Daniels — elite defender'],
  },

  // ─── HISTORICAL LEGENDS EXPANSION ─────────────────────────────────────────
  {
    id: 'wilt', name: 'Wilt Chamberlain', team: 'Lakers (Ret.)', teamColor: '263 52% 33%',
    position: 'C', number: 13, nickname: 'The Big Dipper', tier: 'legend',
    videoFile: '', imageUrl: espn(4076),
    college: 'Kansas', draftYear: 1959,
    facts: ['Scored 100 points in a single game on March 2, 1962', 'Averaged 50.4 PPG for an entire season in 1961-62', 'Led the NBA in assists one season to prove he could do everything'],
    stats: { ppg: '30.1', rpg: '22.9', apg: '4.4' },
    clues: ['This C scored 100 points in a single game', 'He averaged over 50 PPG for a full season and wore #13', 'Wilt Chamberlain — The Big Dipper'],
  },
  {
    id: 'russell', name: 'Bill Russell', team: 'Celtics (Ret.)', teamColor: '150 61% 35%',
    position: 'C', number: 6, nickname: 'Mr. Eleven Rings', tier: 'legend',
    videoFile: '', imageUrl: espn(4076),
    college: 'San Francisco', draftYear: 1956,
    facts: ['Won 11 NBA Championships — the most by any player in history', 'Also served as the first Black head coach in NBA history', 'His #6 was retired league-wide by the NBA in 2022'],
    stats: { ppg: '15.1', rpg: '22.5', apg: '4.3' },
    clues: ['This C won 11 championships and his number was retired league-wide', 'He wore #6 for the Boston Celtics and was the first Black NBA coach', 'Bill Russell — greatest winner in NBA history'],
  },
  {
    id: 'isiah', name: 'Isiah Thomas', team: 'Pistons (Ret.)', teamColor: '0 0% 20%',
    position: 'PG', number: 11, nickname: 'Zeke', tier: 'legend',
    videoFile: '', imageUrl: espn(994),
    college: 'Indiana', draftYear: 1981,
    facts: ['Led the "Bad Boy" Pistons to back-to-back championships in 1989-90', 'Scored 25 points in a quarter of the 1988 NBA Finals on an injured ankle', 'One of the most competitive and fearless point guards in NBA history'],
    stats: { ppg: '19.2', rpg: '3.6', apg: '9.3' },
    clues: ['This PG led the "Bad Boy" Pistons to two straight titles', 'He wore #11 and scored 25 in a Finals quarter on a bad ankle', 'Isiah Thomas — Zeke'],
  },
  {
    id: 'drobinson', name: 'David Robinson', team: 'Spurs (Ret.)', teamColor: '0 0% 20%',
    position: 'C', number: 50, nickname: 'The Admiral', tier: 'legend',
    videoFile: '', imageUrl: espn(163),
    college: 'Navy', draftYear: 1987,
    facts: ['Served two years in the U.S. Navy before joining the NBA', 'Won MVP in 1995 and scored 71 points in a game to win the scoring title', 'Paired with Tim Duncan to win the 1999 and 2003 championships'],
    stats: { ppg: '21.1', rpg: '10.6', apg: '2.5' },
    clues: ['This C served in the Navy and scored 71 points in a game', 'He wore #50 for the Spurs and won MVP in 1995', 'David Robinson — The Admiral'],
  },
  {
    id: 'jwest', name: 'Jerry West', team: 'Lakers (Ret.)', teamColor: '263 52% 33%',
    position: 'SG', number: 44, nickname: 'The Logo', tier: 'legend',
    videoFile: '', imageUrl: espn(4077),
    college: 'West Virginia', draftYear: 1960,
    facts: ['His silhouette is the basis for the NBA logo', 'Only player to win Finals MVP on the losing team (1969)', 'Averaged 27 PPG over 14 seasons with the Lakers'],
    stats: { ppg: '27.0', rpg: '5.8', apg: '6.7' },
    clues: ['This SG\'s silhouette became the NBA logo', 'He won Finals MVP on the losing team in 1969 wearing #44', 'Jerry West — The Logo'],
  },
  {
    id: 'maravich', name: 'Pete Maravich', team: 'Hawks (Ret.)', teamColor: '0 72% 51%',
    position: 'SG', number: 7, nickname: 'Pistol Pete', tier: 'legend',
    videoFile: '', imageUrl: espn(4080),
    college: 'LSU', draftYear: 1970,
    facts: ['Averaged 44.2 PPG in college — a record that still stands', 'Pioneered flashy passes and ball-handling decades before it was common', 'Tragically died at age 40 during a pickup basketball game'],
    stats: { ppg: '24.2', rpg: '4.2', apg: '5.4' },
    clues: ['This SG averaged 44.2 PPG in college — still the all-time record', 'He wore #7 and was nicknamed "Pistol"', 'Pete Maravich — Pistol Pete'],
  },
  {
    id: 'frazier', name: 'Walt Frazier', team: 'Knicks (Ret.)', teamColor: '0 0% 20%',
    position: 'PG', number: 10, nickname: 'Clyde', tier: 'legend',
    videoFile: '', imageUrl: espn(4078),
    college: 'Southern Illinois', draftYear: 1967,
    facts: ['Led the Knicks to NBA Championships in 1970 and 1973', 'Known for his stylish wardrobe and smooth playing style', 'Had 36 points, 19 assists, and 7 rebounds in Game 7 of the 1970 Finals'],
    stats: { ppg: '18.9', rpg: '5.9', apg: '6.1' },
    clues: ['This PG had 36-19-7 in Game 7 of the 1970 Finals', 'He wore #10 for the New York Knicks and is nicknamed "Clyde"', 'Walt Frazier — Knicks legend'],
  },
  {
    id: 'gervin', name: 'George Gervin', team: 'Spurs (Ret.)', teamColor: '0 0% 20%',
    position: 'SG', number: 44, nickname: 'The Iceman', tier: 'legend',
    videoFile: '', imageUrl: espn(4079),
    college: 'Eastern Michigan', draftYear: 1974,
    facts: ['Won four scoring titles with the San Antonio Spurs', 'Known for his iconic finger roll — the smoothest shot in basketball', 'Scored 63 points in a single game during the 1978 season'],
    stats: { ppg: '26.2', rpg: '4.6', apg: '2.8' },
    clues: ['This SG won 4 scoring titles and invented the famous finger roll', 'He wore #44 for the San Antonio Spurs', 'George Gervin — The Iceman'],
  },
  {
    id: 'kidd', name: 'Jason Kidd', team: 'Nets (Ret.)', teamColor: '0 0% 20%',
    position: 'PG', number: 5, nickname: 'J-Kidd', tier: 'mvp',
    videoFile: '', imageUrl: espn(429),
    college: 'California', draftYear: 1994,
    facts: ['Led the Nets to back-to-back NBA Finals appearances in 2002-03', 'Won an NBA Championship with the Dallas Mavericks in 2011', 'Second all-time in career assists and steals at the time of retirement'],
    stats: { ppg: '12.6', rpg: '6.3', apg: '8.7' },
    clues: ['This PG led the Nets to consecutive Finals and won a title with Dallas', 'He wore #5 and was second all-time in assists at retirement', 'Jason Kidd — J-Kidd'],
  },
  {
    id: 'benwallace', name: 'Ben Wallace', team: 'Pistons (Ret.)', teamColor: '0 0% 20%',
    position: 'C', number: 3, nickname: 'Big Ben', tier: 'mvp',
    videoFile: '', imageUrl: espn(535),
    college: 'Virginia Union', draftYear: 1996,
    facts: ['4× NBA Defensive Player of the Year — went undrafted', 'Anchored the 2004 Pistons team that upset the heavily favored Lakers', 'At 6\'9" was one of the shortest dominant centers in NBA history'],
    stats: { ppg: '5.7', rpg: '9.6', apg: '1.3' },
    clues: ['This undrafted C won Defensive Player of the Year 4 times', 'He wore #3 for the Pistons and stood just 6\'9"', 'Ben Wallace — Big Ben'],
  },
  {
    id: 'webber', name: 'Chris Webber', team: 'Kings (Ret.)', teamColor: '263 52% 33%',
    position: 'PF', number: 4, nickname: 'C-Webb', tier: 'mvp',
    videoFile: '', imageUrl: espn(788),
    college: 'Michigan', draftYear: 1993,
    facts: ['Part of Michigan\'s legendary "Fab Five" freshman class', 'Led the Sacramento Kings to the 2002 Western Conference Finals', 'Known for the controversial timeout call in the 1993 NCAA Championship'],
    stats: { ppg: '20.7', rpg: '9.8', apg: '4.2' },
    clues: ['This PF was part of the "Fab Five" and led the early 2000s Kings', 'He wore #4 and is infamous for a timeout call in the 1993 NCAA Finals', 'Chris Webber — C-Webb'],
  },
  {
    id: 'mourning', name: 'Alonzo Mourning', team: 'Heat (Ret.)', teamColor: '0 72% 51%',
    position: 'C', number: 33, nickname: 'Zo', tier: 'mvp',
    videoFile: '', imageUrl: espn(1046),
    college: 'Georgetown', draftYear: 1992,
    facts: ['2× NBA Defensive Player of the Year (1999, 2000)', 'Overcame a kidney transplant to return and win the 2006 NBA Championship', 'One of the most intense and physical centers of the 1990s'],
    stats: { ppg: '17.1', rpg: '8.5', apg: '1.2' },
    clues: ['This C overcame a kidney transplant to win a championship in 2006', 'He wore #33 for the Miami Heat and won DPOY twice', 'Alonzo Mourning — Zo'],
  },
  {
    id: 'mutombo', name: 'Dikembe Mutombo', team: 'Nuggets (Ret.)', teamColor: '200 80% 38%',
    position: 'C', number: 55, nickname: 'Mount Mutombo', tier: 'legend',
    videoFile: '', imageUrl: espn(1048),
    college: 'Georgetown', draftYear: 1991,
    facts: ['4× NBA Defensive Player of the Year', 'Famous for his finger wag after blocking shots', 'Born in the Democratic Republic of Congo and is a humanitarian icon'],
    stats: { ppg: '9.8', rpg: '10.3', apg: '1.0' },
    clues: ['This Congolese C won DPOY 4 times and is famous for his finger wag', 'He wore #55 and played for the Denver Nuggets early in his career', 'Dikembe Mutombo — Mount Mutombo'],
  },
  {
    id: 'pennyhardaway', name: 'Anfernee Hardaway', team: 'Magic (Ret.)', teamColor: '142 71% 45%',
    position: 'PG', number: 1, nickname: 'Penny', tier: 'mvp',
    videoFile: '', imageUrl: espn(524),
    college: 'Memphis', draftYear: 1993,
    facts: ['Formed a legendary duo with Shaquille O\'Neal in Orlando', 'Had his own Nike shoe line with the famous "Lil\' Penny" puppet campaign', 'Career derailed by knee injuries but at his peak was compared to Magic Johnson'],
    stats: { ppg: '15.2', rpg: '4.5', apg: '5.0' },
    clues: ['This PG paired with young Shaq in Orlando and had his own Nike puppet', 'He wore #1 and was nicknamed "Penny"', 'Anfernee Hardaway — Penny'],
  },
];
